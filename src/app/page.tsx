...
import { problems, services, painPoints, steps, whyUs } from "@/data/home";
  ...
  return (
    <>
      ...
      <section className="px-6 py-20 bg-bg-alt">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-sm font-semibold text-ink">
            很多品牌的问题并不只是视觉老旧，而是品牌认知、价值表达和内容结构，已经无法承接当前业务阶段。
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-3xl">
          <SectionIntro
            ...
            body="rebranding 服务那些已经有业务基础、正在进入新阶段，但品牌表达还没有同步升级的企业。我们关注的不只是品牌看起来是否更好，而是客户是否能更快理解你是谁、你的业务价值是否被更准确地表达出来、你的官网提案与销售材料是否在说同一件事、你的品牌是否足以支撑更高质量的客户合作与增长。"
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-3xl">
          <SectionIntro title="比起做什么，很多客户更需要先知道：问题到底出在哪。" />
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-6">
            <div className="border-l-2 border-accent pl-5">
              ...
              <p className="text-sm text-muted">查看我们如何帮助成长型品牌重新组织认知结构，让客户更快理解核心价值。</p>
            </div>
            <div className="border-l-2 border-accent pl-5">
      ...
      <CTASection
        ...
        body="你可以带着当前官网、品牌资料、销售提案或项目背景来沟通。我们会先帮助你判断问题更偏定位、架构、表达还是视觉，是否适合直接做完整品牌升级，更合理的项目切入方式是什么。"
        primaryLabel="预约品牌诊断"
        primaryHref="/contact/"
